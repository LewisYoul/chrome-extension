...
var appView;
  ...
  describe("#returnWordInElements", function() {
    it("returns the word, its lexicalCategory and its definition in HTML", function() {
      ...
      expect(appView.returnWordInElements(testWord)).toEqual('<h1 class="word-title">stock</h1><p>Verb</p><p class="word-description">keep a particular product</p><p id="next">NEXT</p>')
    });
  });
});
